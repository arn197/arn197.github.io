...
<button onMouseOver="this.style.background-color='#000'" onMouseOut="this.style.background-color='#FFF'" onclick="window.location.href = 'mailto:aaronjacobmscs@gmail.com';" style="border: 2px solid #000;color: white">Contact Me</button>